...
namespace Illuminate\Database\Schema {
     ...
     * @method BlueprintColumn bigInteger(string  $column, bool $autoIncrement = false, bool $unsigned = false)
     ...
     * @method BlueprintColumn float(string)
     * @method BlueprintColumn text(string  $column, int $total = 8, int $places = 2)
